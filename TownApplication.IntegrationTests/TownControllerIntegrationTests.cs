namespace TownApplication.IntegrationTests
{
    public class TownControllerIntegrationTests
    {
        ...
        public void UpdateTown_ShouldUpdatePopulation()
        {
            ...
            var updatedTowm = _controller.GetTownByName(townName);
            Assert.NotNull(updatedTowm);
            Assert.Equal(updatedPopulation, updatedTowm.Population);
        }
        ...
        public void ListTowns_ShouldReturnTowns()
        {
            ...
            var townsToAdd = new List<string> { "Varna","Plovdiv","Sofia"};
            foreach (var town in townsToAdd)
            {
                _controller.AddTown(town, town.Length * 2);
            }
            ...
            foreach (var town in townsToAdd)
            {
                ...
                Assert.Equal(town.Length * 2, townExist.Population);
            }
        }
    }
}
